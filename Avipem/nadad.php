...
<html lang="es">
<head>
	<title>Lista de usuarioss</title>
	<meta charset="utf-8">
</head>
<body>
	<center>
			...
			<?php 
				foreach ($alumnos as $dato) {
					...
					<tr>
						...
						<td><a href="Sys/editar.php?id=<?php echo $dato->id_alumno; ?>">Editar</a></td>
						<td><a href="Sys/eliminar.php?id=<?php echo $dato->id_alumno; ?>">Eliminar</a></td>
					</tr>
					<?php
				}
			?>
		...
		<form method="POST" action="Sys/insertar.php">
			<table>
				<tr>
					<td>Apellido paterno: </td>
